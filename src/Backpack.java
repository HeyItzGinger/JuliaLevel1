...
public class Backpack {
	...
	public static void main (String[] args){
		...
		Backpack bert = new Backpack();
		Pencil penelope = new Pencil();
		Ruler ronald = new Ruler();
		Textbook tom = new Textbook();
	 penelope.write(":)");
	 ronald.measure();
	 tom.read();
	 bert.putInBackpack(tom);
	 bert.putInBackpack(ronald);
	 bert.putInBackpack(penelope);
	 bert.goToSchool();
