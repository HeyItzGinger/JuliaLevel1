...
public class Jukebox implements Runnable, MouseListener {
	Song song = new Song("CalmingMusic.mp3");
	Song song2 = new Song("HappyMusic.mp3");
	JPanel calm = new JPanel();
	JPanel happy = new JPanel();
	JPanel p = new JPanel();
	...
	public void run() {
		 ...
		 */
		calm.addMouseListener(this);
		happy.addMouseListener(this);
		calm.add(loadImage("Calming.jpg"));
		happy.add(loadImage("Happy.jpg"));
	...
	public void mousePressed(MouseEvent e) {
		// TODO Auto-generated method stub
		if (e.getComponent() == calm) {
			song.play();
			song2.stop();
		} else if (e.getComponent() == happy) {
			song2.play();
			song.stop();
		} else {
			song.stop();
